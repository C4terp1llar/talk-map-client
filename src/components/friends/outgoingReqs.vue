...
onMounted(async () => {
  friendsStore.viewMode = 'outgoing';

  await friendsStore.getFriendReqs('outgoing', 'load')
...
<template>
  <div class="outgoing-reqs__wrapper">
    <friends-reqs-list v-if="!friendsStore.pending" mode="outgoing"/>
    <lazy-placeholder-loader v-else/>
  </div>
</template>

<style scoped lang="scss">
.outgoing-reqs__wrapper{
  height: 100%;
  width: 100%;
}
</style>